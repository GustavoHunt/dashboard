...
export class SidebarComponent implements OnInit {
    ...
    ngOnInit() {
       ...
       if (this.userModel.team.project == "lcs") {
            this.siteName = "LCS";
            $('.sidebar-background').css('background-image', 'url("assets/img/sidebar-3.jpg")');
            $('.sidebar').attr('data-background-color', 'black');
        } else if (this.userModel.team.project == "overhead") {
            this.siteName = "Overhead";
            $('.sidebar-background').css('background-image', 'url("assets/img/sidebar-4.jpg")');
            $('.sidebar').attr('data-background-color', 'black');
        }  else  {
            this.siteName = "Msite";
        }  
